              		...
              		<thead> 
              			...
              			<tbody>
              				<tr v-for="especie in especies">
          						...
          						<td><button class="btn btn-danger" @click="eliminarEspecie(especie.id_especie)">Eliminar</button></td>					
              				</tr>
              			</tbody>
              		</thead>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
        	...
        	<div class="col">
        		<input type="text" class="form-control" placeholder="nombre especie">
        	</div>
